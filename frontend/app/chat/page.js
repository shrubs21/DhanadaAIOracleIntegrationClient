...
export default function Page() {
  ...
  async function sendMessage(prompt) {
    const finalPrompt =
      prompt?.trim() ||
      (uploadedFileData
        ? `Analyze the attached file: ${uploadedFileData.filename}`
        : '')
    ...
    <div className="flex h-screen bg-white">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div
          ...
          className="flex-1 overflow-y-auto px-6 py-6 bg-white chat-scroll"
        >
          {messages.length === 0 ? (
            <motion.div 
        ...
        <div className="bg-white border-t border-[#E5E7EB] px-6 py-4 shadow-sm">
          ...
          {uploading && selectedFile && (
            <motion.div 
              ...
              animate={{ opacity: 1, y: 0 }}
              className="mb-4 max-w-3xl mx-auto p-4 bg-blue-50 border-2 border-blue-200 rounded-2xl flex items-center gap-3 shadow-sm"
            >
              <div className="flex-shrink-0">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div>
              </div>
              <div className="flex-1 min-w-0">
                <div className="font-semibold text-sm text-[#0B132B]">
              ...
              <button
                ...
                className="flex-shrink-0 px-3 py-1.5 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-lg transition-all"
              >
                Cancel
              </button>
            </motion.div>
