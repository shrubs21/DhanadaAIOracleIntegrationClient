        ...
        <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-2xl p-6 shadow-sm">
          ...
          <div className="text-center mb-6">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl mb-3 bg-[#03045E] shadow-sm">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="28" height="28" fill="white">
            ...
            <h2 className="text-2xl font-bold mb-1 text-[#0B132B]">
              Welcome Back
            </h2>
            <p className="text-sm text-[#475569]">Sign in to continue</p>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="flex items-center pt-1">
              <input 
                ...
                disabled={isLoading}
              />
              <label htmlFor="remember" className="ml-3 text-xs text-[#475569] cursor-pointer font-medium">
