  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8 bg-white">
      ...
      >
        ...
        <Link 
          href="/"
          className="inline-flex items-center gap-2 text-[#475569] hover:text-[#0B132B] mb-6 transition-all duration-300 group"
        >
        ...
        <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-2xl p-6 shadow-sm">
          ...
          <div className="text-center mb-6">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl mb-3 bg-[#03045E] shadow-sm">
            ...
            <h2 className="text-2xl font-bold mb-1 text-[#0B132B]">Create Account</h2>
            <p className="text-sm text-[#475569]">Join us and start your journey</p>
          </div>

          {/* Error Message */}
          {error && (
            <div className="mb-4 p-3 rounded-xl text-sm font-medium text-red-700 bg-red-50 border border-red-200 flex items-start gap-3">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <input 
                ...
                className="w-full px-4 py-3 rounded-xl text-[#0B132B] placeholder-[#6B7280] bg-white border border-[#E5E7EB] focus:outline-none focus:border-[#03045E] transition-all duration-300"
                required
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full px-4 py-3 pr-12 rounded-xl text-[#0B132B] placeholder-[#6B7280] bg-white border border-[#E5E7EB] focus:outline-none focus:border-[#03045E] transition-all duration-300 [&::-ms-reveal]:hidden [&::-ms-clear]:hidden [&::-webkit-credentials-auto-fill-button]:hidden [&::-webkit-contacts-auto-fill-button]:hidden"
                  required
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-[#6B7280] hover:text-[#0B132B] transition-colors duration-300 z-10"
                >
                  {showPassword ? (
                    ...
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M10.5 10.677a2 2 0 0 0 2.823 2.823" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
            ...
            <div className="flex items-start pt-1">
              ...
              />
              <label htmlFor="terms" className="ml-3 text-xs text-[#475569] cursor-pointer font-medium">
                I agree to the{' '}
        ...
        {/* Trust Badges */}
        <div className="mt-6 flex items-center justify-center gap-8 text-xs text-[#475569]">
